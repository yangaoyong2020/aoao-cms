...
<body>
	...
	<form id="form1">
	    ...
	    <div class="form-group">
	      ...
	      <input id="title" type="text" name="title" class="form-control" style="width:1000px">
	    </div>
	    
	      <div class="form-group form-inline">
	      
	       <label for="title">所属栏目:</label>
	        <select name="channelId" class="form-control form-control-sm" style="width:150px" id="channels">
	         <option>请选择</option>
	        </select>
	        
	        <label for="title">所属分类:</label>
	        <select name="categoryId" class="form-control form-control-sm" style="width:150px" id="categorys">
	         <option>请选择</option>
	        </select>
		...
		<br />
		<input type="button" name="button" onclick="publis()" class="btn btn-success" value="发布文章" />
	</form>
</body>
